            ...
            <ul class="mt-8 space-y-2 tracking-wide">
                <li>
                    ...
                    >
                        ...
                        <span class="group-hover:text-gray-700 dark:group-hover:text-gray-50">Tableau de bord</span>
                    </a>
                </li>
                <li>
                    <a
        ...
        <div class="container mx-auto p-6">
            <div class="overflow-x-auto shadow-lg rounded-lg">
                <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                    ...
                    @foreach($tbl_2024_etudiant as $etudiant)
                        <tr class="border-b border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="py-3 px-6">{{ $etudiant->student_nom }}</td>
                            <td class="py-3 px-6">{{ $etudiant->student_prenom }}</td>
                            <td class="py-3 px-6">{{ $etudiant->student_mail }}</td>
                            <td class="py-3 px-6">{{ $etudiant->password }}</td>
